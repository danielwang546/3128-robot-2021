...
public class AutoRendezvous extends SequentialCommandGroup {
    ...
    public AutoRendezvous(FalconDrive drive, Shooter shooter, Arm arm, Hopper hopper, AHRS ahrs, Limelight limelight, DriveCommandRunning cmdRunning, double timeoutMs) {       
        addCommands(
            ...
            new CmdAutoTrajectory(drive, 120, 0.5, 10000, 
            ...
            // }
            new CmdAlignShoot(drive, shooter, arm, hopper, ahrs, limelight, cmdRunning, Constants.VisionConstants.TX_OFFSET, 2)
        );
    }
}
