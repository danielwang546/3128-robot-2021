...
public class CmdPleaseWorkTurnTest extends SequentialCommandGroup {
    public CmdPleaseWorkTurnTest(Gyro gyro) {
        ...
        addCommands(SRXTankDrive.getInstance().new CmdPleaseWorkTurn(gyro, 90 * Angle.DEGREES, 4 * Length.ft,
                Direction.LEFT, 0.7, innerPID, outerPID, 6000).withTimeout(6));
    }
}